    ...
    return (
        <FlexCol>
            ...
            <MembersContainer>
                ...
                <Divider>
                    See a list of {companyMock.name}'s team members
                </Divider>
                <div style={{ margin: "10px 0 30px" }}>
                    If you need to edit a particular team member, you can see a
                    complete list of team members and visit their profile to
                    make edits.
                    <b>
                        You will not be able to see a team mamber's weekly
                        report.
                    </b>
                </div>
                <WhiteButton onClick={handleSeeClick}>
