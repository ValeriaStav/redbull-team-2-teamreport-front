  ...
  return (
    <StyledBody>
      <ContentContainer>
        ...
        <InputField placeholder='First Name' type='text' onChange={setFirstName}></InputField>
        <InputField placeholder='Last Name' type='text' onChange={setLastName}></InputField>
        <InputField placeholder='Title' type='text' onChange={setTitle}></InputField>
        ...
        <OverlayContainer>
          <StyledOverlay>
            <OverlayRightPanel>
              ...
              <StyledP>
If you already have an account in the teamplease login with your personal info
              </StyledP>
